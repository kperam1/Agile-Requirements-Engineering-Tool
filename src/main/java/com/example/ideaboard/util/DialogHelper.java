...
public class DialogHelper {
    private static Runnable onIdeaCreatedCallback;
    public static void setOnIdeaCreatedCallback(Runnable callback) {
        onIdeaCreatedCallback = callback;
    }
    public static void notifyIdeaCreated() {
        if (onIdeaCreatedCallback != null) {
            onIdeaCreatedCallback.run();
        }
    }
